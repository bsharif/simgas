...
export function applyModifier(state: PatientState, mod: PatientModifier): void {
  ...
  if (mod.airwayObstructed !== undefined) state.airwayObstructed = mod.airwayObstructed
...
export const INTERVENTIONS: Intervention[] = [
  ...
  },
  {
    ...
    label: 'Adrenaline 1mg (Arrest)',
    category: 'drug',
    description: 'ALS arrest dose. NOT for a patient with a pulse — causes severe hypertension/arrhythmia.',
    effect: { hrDelta: 40, nibpDelta: { sys: 40, map: 25 } },
    durationMs: 180000,
    onsetMs: 5000,
    cooldownMs: 60000,
  },
  ...
  {
    id: 'adenosine',
    label: 'Adenosine 6mg IV',
    category: 'drug',
    description: 'First-line for SVT. Temporarily blocks AV node conduction.',
    effect: { ecgRhythm: 'sinus', hrDelta: -30 },
    durationMs: 0,
    onsetMs: 1500,
    precondition: (s) => s.ecgRhythm === 'svt',
    preconditionFailureEvent: '⚠ Adenosine: no SVT detected — rhythm is already sinus',
    cooldownMs: 15000,
    maxDoses: 3,
  },
  {
    id: 'salbutamol',
    label: 'Salbutamol 5mg neb',
    category: 'drug',
    description: 'Bronchodilator. First-line for bronchospasm.',
    effect: { spo2Delta: 3, etco2Delta: -0.3 },
    durationMs: 0,
    onsetMs: 15000,
    cooldownMs: 20000,
  },
  {
    ...
    category: 'drug',
    description: 'Lipid rescue for local anaesthetic systemic toxicity (LAST).',
    effect: { hrDelta: 15, nibpDelta: { sys: 25, dia: 10 }, ecgRhythm: 'sinus' },
    durationMs: 0,
    onsetMs: 5000,
    cooldownMs: 30000,
  },
  {
    id: 'suxamethonium',
    label: 'Suxamethonium 1mg/kg',
    category: 'drug',
    description: 'Depolarising relaxant. Breaks refractory laryngospasm; enables intubation.',
    effect: {},
    durationMs: 0,
    onsetMs: 0,
    cooldownMs: 30000,
  ...
  },
  {
    ...
    label: 'Midazolam 2mg',
    category: 'drug',
    description: 'Benzodiazepine. First-line for seizures (e.g. LAST prodrome).',
    effect: {},
    durationMs: 0,
    onsetMs: 3000,
    cooldownMs: 15000,
  ...
  },
  {
    ...
    category: 'drug',
    description: 'Antiarrhythmic. ALS: after the 3rd shock in refractory VF/VT.',
    effect: {},
    durationMs: 0,
    onsetMs: 10000,
    cooldownMs: 60000,
  ...
  {
    id: 'atropine',
    label: 'Atropine 600mcg',
    category: 'drug',
    description: 'Antimuscarinic. First-line for symptomatic bradycardia.',
    effect: { hrDelta: 25 },
    durationMs: 0,
    onsetMs: 2000,
    cooldownMs: 10000,
  ...
  {
    id: 'txa',
    label: 'Tranexamic Acid 1g',
    category: 'drug',
    description: 'Antifibrinolytic. Give early in major haemorrhage.',
    effect: {},
    durationMs: 0,
    onsetMs: 0,
    maxDoses: 2,
  ...
  },
  {
    ...
    label: 'Front-of-Neck Access',
    category: 'airway',
    description: 'Scalpel cricothyroidotomy — CICO rescue. Secures an infraglottic airway.',
    effect: { tubePosition: 'trachea', capnographyShape: 'normal' },
    durationMs: 0,
    onsetMs: 0,
    maxDoses: 1,
  },
  ...
  },
  {
    ...
    label: 'PEEP 10',
    category: 'ventilation',
    description: 'Set PEEP to 10 cmH₂O (also adjustable on the machine)',
    effect: { peep: 10 },
    durationMs: 0,
    onsetMs: 0,
  },
  ...
  },
  {
    ...
    label: 'Defibrillate',
    category: 'procedure',
    description: 'Unsynchronised shock 200J biphasic — for VF / pulseless VT',
    effect: { ecgRhythm: 'sinus' },
    durationMs: 0,
    onsetMs: 0,
  },
  {
    id: 'sync-cardioversion',
    label: 'Sync Cardioversion',
    category: 'procedure',
    description: 'Synchronised DC shock — for unstable tachyarrhythmia with a pulse',
    effect: { ecgRhythm: 'sinus' },
    durationMs: 0,
    onsetMs: 0,
    precondition: (s) => s.ecgRhythm === 'svt' || s.ecgRhythm === 'vt',
    preconditionFailureEvent: '⚠ Synchronised cardioversion: no shockable tachyarrhythmia — sync cannot find an R wave',
    cooldownMs: 10000,
    maxDoses: 3,
  },
  {
    ...
    category: 'procedure',
    description: 'Valsalva / carotid sinus massage — first-line for stable SVT',
    effect: {},
    durationMs: 0,
    onsetMs: 0,
    cooldownMs: 10000,
  },
  {
    ...
    label: 'Call for Help',
    category: 'procedure',
    description: 'Declare the emergency — senior help, crash trolley, assign roles',
    effect: {},
    durationMs: 0,
    onsetMs: 0,
    maxDoses: 1,
  },
  {
    ...
    label: 'Stop Trigger',
    category: 'procedure',
    description: 'Stop the offending agent — infusion, antibiotic, insufflation, transfusion',
    effect: {},
    durationMs: 0,
    onsetMs: 0,
    maxDoses: 1,
  },
  {
    ...
    category: 'procedure',
    description: 'Packed red cells via rapid infuser — activate major haemorrhage protocol',
    effect: { nibpDelta: { sys: 25, map: 15 } },
    durationMs: 180000,
    onsetMs: 20000,
    cooldownMs: 30000,
  },
  {
    ...
    category: 'procedure',
    description: 'Intercostal drain — definitive management after needle decompression',
    effect: {},
    durationMs: 0,
    onsetMs: 0,
    maxDoses: 1,
